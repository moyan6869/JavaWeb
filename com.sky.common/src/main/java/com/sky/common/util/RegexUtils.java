...
public class RegexUtils {
    ...
    public static boolean checkStr(String str,int leng){
    	return Pattern.matches("\\w{"+leng+"}$",str);
    }
     ...
     * @return
     */
    public static boolean checkNumLen(String num,int start,int end){
    	return Pattern.matches("^\\d{"+start+","+end+"}$",num);
    }
    
    /**
     * 检测特殊字符  只能a-z,A-Z 0-9,_
     * @param str
     * @return
     */
    public static boolean checkStr(String str,int start,int end){
    	return  Pattern.matches("\\w{"+start+","+end+"}",str);
    }
     ...
     * @return
     */
    public static boolean checkNumLen(String num,int leng){
    	return Pattern.matches("^\\d{"+leng+"}",num);
    }
    ...
    /**
     * 验证日期（年月）
     * @param yearAndMonth 年月，格式：yyyyMM, 如：201602
     * @return 验证成功返回true，验证失败返回false
     */
    ...
    /**
     * 验证日期（年月日）
     * @param date 日期，格式：yyyyMMdd, 如：20160218
     * @return 验证成功返回true，验证失败返回false
     */
    ...
    public static void main( String[] args ){
        ...
        System.out.println("==========="+checkVersion("1.22"));
        System.out.println("==========="+checkVersion("1.16666.2"));
        System.out.println("==========="+checkVersion("1.2.2.2"));
    }
}
