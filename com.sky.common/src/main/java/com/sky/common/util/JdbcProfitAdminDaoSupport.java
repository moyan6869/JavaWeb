 ...
 *
 */
public class JdbcProfitAdminDaoSupport {
	private static Logger log = Logger.getLogger(JdbcProfitAdminDaoSupport.class);
	...
	private static BoneCPDataSource getUserDateSource(){
		BoneCPDataSource boneCPDataSource = SpringUtils.getBean("profitAdminDataSource");
	...
	private static JdbcTemplate getJdbcTemplate(){
		return SpringUtils.getBean("profitAdminJdbcTemplate");
	}
