...
public class CustomDefaultFilterChainManager extends DefaultFilterChainManager {
    Logger log = Logger.getLogger(CustomDefaultFilterChainManager.class);
    ...
    public CustomDefaultFilterChainManager() {
        log.info("CustomDefaultFilterChainManager/CustomDefaultFilterChainManager");
    ...
    public void setDefaultFilterChainDefinitions(String definitions) {
        log.info("CustomDefaultFilterChainManager/setDefaultFilterChainDefinitions:"+definitions);
        Ini ini = new Ini();
    ...
    @PostConstruct
    public void init() {
        log.info("CustomDefaultFilterChainManager/init:");
    ...
    public FilterChain proxy(FilterChain original, List<String> chainNames) {
        log.info("CustomDefaultFilterChainManager/proxy:");
    ...
    private void applyLoginUrlIfNecessary(Filter filter) {
        log.info("CustomDefaultFilterChainManager/applyLoginUrlIfNecessary:");
    ...
    private void applySuccessUrlIfNecessary(Filter filter) {
        log.info("CustomDefaultFilterChainManager/applySuccessUrlIfNecessary:");
    ...
    private void applyGlobalPropertiesIfNecessary(Filter filter) {
        log.info("CustomDefaultFilterChainManager/applyGlobalPropertiesIfNecessary:");
